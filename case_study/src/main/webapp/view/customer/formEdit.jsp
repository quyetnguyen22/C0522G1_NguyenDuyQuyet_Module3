...
<div class="container border border-primary w-50">
    <form class="g-3" action="/Customer?action=edit&id=${customer.getId()}" method="post">
        <div class="col-12">
            <label for="inputName" class="form-label">Name:</label>
            <input type="text" name="customerName" value="${customer.getCustomerName()}" class="form-control" id="inputName">
        </div>

        <div class="col-12">
            <label for="inputBirthday" class="form-label">Date of birth:</label>
            <input type="date" name="customerBirthday" value="${customer.getCustomerBirthday()}" class="form-control" id="inputBirthday">
        </div>
        ...
        <div class="col-12">
            ...
            <input type="text" name="customerIdNum" value="${customer.getCustomerIdNum()}" class="form-control" id="inputIdNum">
        </div>

        <div class="col-12">
            <label for="inputPhoneNum" class="form-label">Phone number:</label>
            <input type="text" name="customerPhone" value="${customer.getCustomerPhone()}" class="form-control" id="inputPhoneNum">
        </div>

        <div class="col-12">
            <label for="inputEmail" class="form-label">Email:</label>
            <input type="text" name="customerEmail" value="${customer.getCustomerEmail()}" class="form-control" id="inputEmail" placeholder="acb@gmail.com">
        </div>

        <div class="col-12">
            <label for="inputAddress" class="form-label">Address:</label>
            <input type="text" name="customerAddress" value="${customer.getCustomerAddress()}" class="form-control" id="inputAddress" placeholder="1234 Main St">
        </div>
