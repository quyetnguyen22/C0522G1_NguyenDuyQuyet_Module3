...
<div class="container col-12">
    <h3 class="text-center"><a href="/Employee?action=showAll" class="text-black text-decoration-none">Employee List</a>
    </h3>
</div>
...
<div class="container">
    ...
    <form>
        <div class="row" style="--bs-gutter-x: 0">
            <div class="col-2">
                <input type="text" name="name" class="form-control form-control-sm" placeholder="Input name">
            </div>
            <div class="col-2 px-0">
                <input type="text" name="phoneNum" class="form-control form-control-sm"
                       placeholder="Input phone number">
            </div>
            <div class="col-2">
                <input type="text" name="address" class="form-control form-control-sm" placeholder="Input address">
            </div>
    ...
    <table class="table table-striped table-bordered" id="employeeTable" style="width: 100%">
        ...
        <tbody>
        <c:forEach varStatus="serises" var="employee" items="${employeeList}">
            <tr>
                <td>${serises.count}</td>
                <td><a href="/Employee?action=showById&id=${employee.getId()}"
                       class="text-decoration-none text-black">${employee.getEmployeeName()}</a>
                </td>
                ...
                <td>
                    <a class="text-decoration-none text-white btn btn-primary btn-sm"
                       href="/Employee?action=edit&id=${employee.getId()}">
                        Edit
                    </a>

                </td>
                <td>
                    <button onclick="idDelete('${employee.getId()}', '${employee.getEmployeeName()}')"
